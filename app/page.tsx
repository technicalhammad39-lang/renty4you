...
export default function Home() {
  return (
    <main className="min-h-screen">
      <Navbar />
      <Hero />
      <div className="relative z-10 w-full bg-background rounded-t-[40px] mt-[-2px]">
        {/* Search Bar floats at the top of the scrolling area, centering on the boundary */}
        <div className="relative z-20 w-full max-w-7xl mx-auto px-6 -translate-y-1/2 mb-[-40px]">
          <SearchBar />
        </div>
        <ComplianceStrip />
        <CoreStrategies />
