...
export function Hero() {
  ...
  return (
    <div ref={containerRef} className="sticky top-0 left-0 w-full h-[85vh] min-h-[650px] overflow-hidden z-0 bg-black flex flex-col justify-center">
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 md:px-8 xl:px-12 pt-28 pb-16 md:pt-0 md:pb-0 flex flex-col justify-center mt-8 md:mt-0">
        <div ref={textRef} className="w-full text-white flex flex-col gap-4 md:gap-5">
          <motion.h1
            initial={{ opacity: 0, y: 30, filter: "blur(10px)" }}
            animate={{ opacity: 1, y: 0, filter: "blur(0px)" }}
            transition={{ duration: 0.8, delay: 0.2 }}
            className="text-[32px] sm:text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.15] text-white max-w-4xl text-left"
          >
          ...
          <motion.p
            ...
            className="text-sm sm:text-base md:text-lg text-gray-300 leading-relaxed max-w-xl text-left mt-1 md:mt-2"
          >
